...
workbook = xlsxwriter.Workbook('Pereira2018-lang-'+comparison+'-specificity-not-ceiled-'+timestamp+'.xlsx')
...
worksheet.write(0, 4, 'Comparison1_Predictivity')
worksheet.write(0, 5, 'Comparison2_Predictivity')
...
for idx, model in enumerate(models_pkl):
    ...
    diff, mult, perc, center_lang, center_comp, best_layer = computeDropNoCeil(score,comparison)
    ...
    worksheet.write(idx+1, col + 4, center_lang) 
    worksheet.write(idx+1, col + 5, center_comp) 
